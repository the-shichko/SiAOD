...
namespace example8
{
    class Program
    {
            ...
            while (input != "5")
            {
                ...
                switch (input)
                {
                    ...
                    case "4":
                        ...
                        Console.WriteLine(tree.Show(1));
                        Console.WriteLine("Sim:");
                        Console.WriteLine(tree.Show(0));
                        Console.WriteLine("Rev:");
                        Console.WriteLine(tree.Show(2));
                        break;
                    case "5":
                        break;
                    default:
        ...
        private static int[] RandEnt(int count)
        {
            var input = new int[count];
            var rnd = new Random();
            for (var i = 0; i < count; i++)
        ...
        private static BinTree<int> Ent(BinTree<int> tree)
        {
            string val;
            var n = 15;
            int[] input;
